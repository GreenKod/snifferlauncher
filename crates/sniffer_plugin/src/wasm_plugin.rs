use sniffer_core::ui::data_map::{DataMap, DataValue, DrawCommand};
...
pub struct HostState {
    ...
    pub actions: Option<std::sync::Arc<std::sync::Mutex<Vec<sniffer_core::types::Action>>>>,
}
...
impl WasmPlugin {
    ...
    pub fn new(wasm_bytes: &[u8]) -> Result<Self, String> {
        ...
        let host_execute_action = Func::wrap(
            ...
            |caller: Caller<'_, HostState>, action_id: i32| {
                ...
                let action = match action_id {
                    1 => sniffer_core::types::Action::OpenSettings,
                    2 => sniffer_core::types::Action::OpenContacts,
                    3 => sniffer_core::types::Action::OpenCamera,
        ...
        Ok(Self {
            subscriptions: vec![
                sniffer_core::ui::widget::ids::BTN_SETTINGS,
                sniffer_core::ui::widget::ids::BTN_CONTACTS,
                sniffer_core::ui::widget::ids::BTN_CAMERA,
            ],
