use sniffer_render::text::font_atlas::{
    FontAtlas, GlyphInfo, discover_system_fonts, estimate_text_width,
};
...
fn test_font_atlas_text_width_with_turkish_and_emoji() {
    ...
    let atlas = FontAtlas::new_mock(dummy_tex, glyphs, 64.0, 50.0, 16.0);
